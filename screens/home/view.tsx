...
import { additivesForTeaAndCoffee, beer, blackTeas, chineseTeas, coffee, coldDrinks, glintwein, greenTeas, hotTeas, lemonades, matchaLatte, milkshakes, ratte, snacks, teaDrinks } from '@/shared/config/positions';
